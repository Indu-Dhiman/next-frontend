...
const Sidebar = () => {
  ...
  const menuItems =
    user?.role === "admin"
      ...
      : [
          ...
          { name: "Settings", path: "/user/settings", icon: <FiHome /> },
  ...
  return (
    <div>
      ...
      <aside
        className={`m-2 rounded-xl bg-[#164e63] text-white h-screen w-64 fixed md:static transition-transform duration-300 ease-in-out z-50 md:translate-x-0 ${
